...
const myEmployeesAddresses = _.map(myEmployees, cur => cur.address);

// Now we want to use map to get an array of ages of the employees.

// const myEmployeesAges = 0; // use map to get ages here.
const myEmployeesAges = _.map(myEmployees, cur => cur.age);
...
const purchasesByMonth = _.groupBy(purchases, cur => cur.month);
